...
(function ($) {
  $("#Integra2__Boton").append(
    '<div id="readline"></div><div class="fab" id="integra2_myBtn"><img id="integra2_myBtn__img" alt="Usar teclado para desplazarse" /></div><div id="lemodale" class="integra2_modale" data-keyboard="true" data-target="#lemodale"><div class="integra2_modale-content" id="lemodaleposition"><div class="integra2_modale-header">Men&uacute; Accesible (CTRL+M)<span class="integra2_close">x</span></div><div class="integra2_row"><div class="integra2_column divhover" id="focus_active"><div class="optioon" id="focusx" tabindex="0"><div id="focus_checked"></div><img id="focusx__img" alt="Usar teclado para desplazarse" />Teclado</div></div><div class="integra2_column divhover" id="voice_active"><div class="optioon" id="voice" tabindex="0"><div id="voice_checked"></div><img id="voice__img" alt="Utilizar lectura de pantalla" />Voz(Insert+&#8595;)</div></div></div><div class="integra2_row"><div class="integra2_column divhover" id="contrastview_active"><div class="optioon" id="contrastview" tabindex="0"><div id="contrastview_checked"></div><img id="contrastview__img" alt="Cambiar contraste" />Contrastes<div class="optsioon" id="contrastview_step"></div></div></div><div class="integra2_column divhover" id="integra2_linkcolor_active"><div class="optioon" id="integra2_linkcolor" tabindex="0"><div id="integra2_linkcolor_checked"></div><img id="integra2_linkcolor__img" alt="Iluminar hiperv&iacute;nculos" />Hiperv&iacute;nculos</div></div></div><div class="integra2_row"><div class="integra2_column divhover" id="size_active"><div class="optioon" id="size" tabindex="0"><div id="size_checked"></div><img id="size__img" alt="Cambiar tama&ntilde;o de texto" />Tama&ntilde;o Texto<div class="optsioon" id="size_step"></div></div></div><div class="integra2_column divhover" id="letterspace_active"><div class="optioon" id="letterspace" tabindex="0"><div id="letterspace_checked"></div><img id="letterspace__img" alt="Separar texto" />Espacios<div class="optsioon" id="letterspace_step"></div></div></div></div><div class="integra2_row"><div class="integra2_column divhover" id="apagatransition_active"><div class="optioon" id="apagatransition" tabindex="0"><div id="apagatransition_checked"></div><img id="apagatransition__img" alt="Detener animaciones" />Sin Animaciones<div class="optsioon" id="apagatransition_step"></div></div></div><div class="integra2_column divhover" id="legible_active"><div class="optioon" id="legible" tabindex="0"><div id="legible_checked"></div><img id="legible__img" alt="Texto legible" />Texto Legible<div class="optsioon" id="legible_step"></div></div></div></div><div class="integra2_row"><div class="integra2_column divhover" id="pointerx_active"><div class="optioon" id="pointerx" tabindex="0"><div id="pointerx_checked"></div><img id="pointerx__img" alt="Tama&ntilde;o de puntero" />Puntero</div></div><div class="integra2_column divhover" id="readline_active"><div class="optioon" id="readlinex" tabindex="0"><div id="readline_active_checked"></div><img id="readlinex__img" alt="L&iacute;nea de lectura" />L&iacute;nea de Lectura</div></div></div><div class="integra2_row"><div class="integra2_column divhover" id="integra2_Btnlinks"><div class="optioon" tabindex="0"><div id="optioon__div"></div>Links(Ctrl+F7)</div></div><div class="integra2_column divhover" id="location_kactive"><div class="optioon" id="location" tabindex="0"><div id="imgpos"></div>Posici&oacute;n</div></div></div><div class="integra2_row"><div class="integra2_column_single divhover" id="resetb"><div class="optioon_single" tabindex="0"><img id="resetb__img" alt="Reiniciar ajustes" />Reiniciar</div></div></div><div class="integra2_modale-footer integra2--abrirmicrositio"><div>Micrositio de Integra2</div></div></div></div><div id="lemodale2" class="integra2_modale2" data-keyboard="true" data-target="#lemodale2"><input type="hidden" hidden id="integra2_text_focus" /><div class="integra2_modale-content2" id="lemodaleposition"><div class="integra2_modale-header"><span>Links del portal</span><span class="integra2_close2"> X</span></div><span id="integra2_links"></span><div class="integra2_modale2-footer integra2--abrirmicrositio"><div>Micrositio de Integra2</div></div></div></div>'
  );
    ...
    $("#size").keypress(function (e) {
      if (e.which == 13) {
        ...
        if (classes[classes.length - 1] === "reset") {
          ...
          $("a").removeClass("integra2_size1 integra2_size2 integra2_size3 integra2_size4 reset");
          $("label").removeClass(
            "integra2_size1 integra2_size2 integra2_size3 integra2_size4 reset"
          );
          $("#size_active").removeClass("activatedcell");
          $("#size_checked").removeClass("iconchecked");
          localStorage["integra2_size"] = "";
